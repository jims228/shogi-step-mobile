...
export const ROADMAP_NODES: RoadmapNode[] = [
  ...
  { id: "u2_silver_use", title: "ここまでの復習", unitId: "s1", nodeType: "review", description: "歩・金・王・銀の動きの復習", implemented: true },
  ...
  { id: "u2_range_review", title: "飛角桂香のまとめ", unitId: "s1", nodeType: "review", description: "飛車・角・桂馬・香車の復習", implemented: true },

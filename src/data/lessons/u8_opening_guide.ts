...
export const U8_OPENING_GUIDE: LessonData = {
  ...
  steps: [
    ...
    // step2: 76歩 - 角道を開ける
    {
      ...
      result_sfen: "lnsgkgsnl/1r5b1/pp1pppppp/2p6/9/2P4P1/PP1PPPP1P/1B5R1/LNSGKGSNL b - 3",
      auto_response: {
        from: { row: 2, col: 7 },
        to: { row: 3, col: 7 },
      },
    ...
    // step3: 25歩 - 飛車先をさらに伸ばす
    {
      ...
      result_sfen: "lnsgkgsnl/1r5b1/pp1ppppp1/2p4p1/7P1/2P6/PP1PPPP1P/1B5R1/LNSGKGSNL b - 5",
    ...
    // step4: 48銀 - 囲いの準備
    {
      ...
      result_sfen: "lnsgkgsnl/1r5b1/pp1ppppp1/2p4p1/7P1/2P6/PP1PPPP1P/1B3S1R1/LNSGKG1NL b - 5",
    ...
    // step6: 68王 - 王を囲いへ
    {
      ...
      result_sfen: "lnsgkgsnl/1r5b1/pp1ppppp1/2p4p1/7P1/2P6/PP1PPPP1P/1B1K1S1R1/LNSG1G1NL b - 5",
      success_text: "すばらしい！\n原則に沿った序盤が指せたぞ！\n飛車先を突く→角道を開ける→囲い\nこの流れを覚えておくんじゃ！",

...
export const U3_PROMOTE_DO: LessonData = {
  ...
  steps: [
    // step1: 歩を成る（ガイド）
    {
      ...
      coach_text: "歩を前に進めて敵陣に入ろう。敵陣に入ると成れるぞ！",
      ...
      result_sfen: "9/9/4+P4/9/9/9/9/9/9 b - 1",
    ...
    // step2: 銀を成る（ガイド）
    {
      id: "promote_silver",
      type: "move",
      board_sfen: "9/9/4p4/4S4/9/9/9/9/9 b - 1",
      instruction: "銀を進めて成ろう！",
      coach_text: "銀で歩を取って敵陣に入ろう。成るかどうか聞かれるぞ！「成る」を選ぼう。",
      arrows: [{ from: [3, 4], to: [2, 4] }],
      correct_move: {
        from: { row: 3, col: 4 },
        to: { row: 2, col: 4 },
      ...
      correct_promotion: true,
      result_sfen: "9/9/4+S4/9/9/9/9/9/9 b P 1",
    ...
    // step3: 成らない選択
    {
      ...
      coach_text: "成るかどうかは選べるぞ。今回は「成らない」を選んでみよう。銀のまま残す場面もあるんじゃ。",
      arrows: [{ from: [3, 4], to: [2, 4] }],
      correct_move: {
        from: { row: 3, col: 4 },
        to: { row: 2, col: 4 },
      ...
      result_sfen: "9/9/4S4/9/9/9/9/9/9 b P 1",
    ...
    // step6: 角を成る（自力）
    {
      id: "promote_bishop",
      type: "move",
      board_sfen: "9/9/6p2/9/9/9/2B6/9/9 b - 1",
      instruction: "角を成らせよう！",
      coach_text: "仕上げじゃ！角が成ると「馬」になる。馬は斜め＋縦横1マスの強い駒じゃ！",
      correct_move: {
        from: { row: 6, col: 2 },
        to: { row: 2, col: 6 },
      },
      correct_promotion: true,
      result_sfen: "9/9/6+B2/9/9/9/9/9/9 b P 1",

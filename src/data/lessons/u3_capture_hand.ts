...
export const U3_CAPTURE_HAND: LessonData = {
  ...
  steps: [
    ...
    // step4: クイズ - 持ち駒はいつ使える？
    {
      ...
      coach_text: "持ち駒は自分の番に\n使えるぞ。どうやって\n使うんじゃろう？",
      quiz_options: ["好きな空きマスに打てる", "元の位置にしか置けない"],
      quiz_answer: 0,
      success_text: "正解！持ち駒は好きな空きマスに\n打てるんじゃ！（いくつかルールは\nあるがな）これは次のレッスンで\n学ぶぞ。",

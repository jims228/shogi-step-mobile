...
export const U5_ESCAPE: LessonData = {
  ...
  steps: [
    // step1: 飛車の王手から逃げる（ガイド）
    {
      ...
      result_sfen: "3K5/9/9/9/4r4/9/9/9/9 b - 1",
    ...
    // step2: 角の王手から逃げる
    {
      ...
      result_sfen: "3K5/9/9/9/9/9/9/1b7/9 b - 1",
    ...
    // step3: 金の王手から逃げる
    {
      ...
      result_sfen: "4K4/9/4g4/9/9/9/9/9/9 b - 1",
      success_text: "逃げられたぞ！\n金は斜め後ろに効かないから\n上に逃げるのが安全じゃ。",
    ...
    // step5: 安全な場所を選んで逃げる
    {
      ...
      result_sfen: "4K4/9/9/3g5/9/9/9/9/9 b - 1",
    ...
    // step6: 仕上げ
    {
      ...
      result_sfen: "9/3K5/9/9/4r4/9/9/9/9 b - 1",
      success_text: "すばらしい！\n「逃げる」受けをマスターしたな！",
